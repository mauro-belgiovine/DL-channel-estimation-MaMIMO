function H_MMSE = LMMSE_ce(H_tilde,Nfft,Np,Nps,h,SNR) 
                 %LMMSE_ce(Y,Xp,pilot_loc,Nfft,Nps,h,SNR)
%LMMSE_CE Summary of this function goes here
...
%H_MMSE = transpose(Rhp*inv(Rpp)*H_tilde.'); % it was like this, H_tilde had inverted shape
end
